...
let currentStarSpeed = starSpeed;
let currentAutoCenterRepulsion = autoCenterRepulsion;
    resize();
...
function update(t) {
  ...
  if (!disableAnimation) {
    ...
    program.uniforms.uStarSpeed.value = currentStarSpeed;
    program.uniforms.uAutoCenterRepulsion.value = currentAutoCenterRepulsion;
  }
